...
coverall:
	goveralls -service=travis-ci -package github.com/mirakl/kube-named-ports/pkg/...

test:
	go test -i github.com/mirakl/kube-named-ports/...
	go test -race -cover github.com/mirakl/kube-named-ports/...
